...
vm_page_t * mm_get_available_page_from_heap_segment() {
...
static inline uint32_t mm_max_page_allocatable_memory() {
...
static vm_page_t * mm_get_available_page_index(vm_page_family_t *vm_page_family) {
...
static vm_bool_t mm_allocate_free_block(
        vm_page_family_t *vm_page_family,
...
static vm_page_t * mm_get_page_satisfying_request(
        vm_page_family_t *vm_page_family,
        uint32_t req_size,
...
static void mm_return_vm_page_to_heap_segment(vm_page_t *vm_page) {
...
void mm_print_memory_usage(char *struct_name) {
    ...
    float memory_app_use_to_total_memory_ratio = 0.0f;
